...
router.patch("/update/:id", checkAuth(UserRole.ADMIN), validateRequest(updateTransactionZodSchema), transactionController.updateTransactionC);
router.delete("/delete/:id", checkAuth(UserRole.ADMIN), transactionController.deleteTransactionC);
